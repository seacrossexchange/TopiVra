...
// Lazy redirect wrapper (for alias routes like /auth/login)
const LazyRedirect = ({ to }: { to: string }) => <Navigate to={to} replace />;
...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      // ─── User routes ────────────────────────────────────────────────────────
      {
        ...
        children: [
          { index: true, element: <LazyRedirect to="/user/profile" /> },
          {
            path: 'profile',
            element: (
              <LazyWrapper>

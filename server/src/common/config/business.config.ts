...
export class BusinessConfig {
  ...
  static getOrderAutoCancelMinutes(): number {
    return Number(process.env.ORDER_AUTO_CANCEL_MINUTES) || BUSINESS_DEFAULTS.ORDER_AUTO_CANCEL_MINUTES;
  }
  ...
  static getOrderAutoConfirmDays(): number {
    return Number(process.env.ORDER_AUTO_CONFIRM_DAYS) || BUSINESS_DEFAULTS.ORDER_AUTO_CONFIRM_DAYS;
  }
  ...
  static getDefaultCommissionRate(): number {
    return Number(process.env.DEFAULT_COMMISSION_RATE) || BUSINESS_DEFAULTS.DEFAULT_COMMISSION_RATE;
  }
  ...
  static getPaymentExpirationMinutes(): number {
    return Number(process.env.PAYMENT_EXPIRATION_MINUTES) || BUSINESS_DEFAULTS.PAYMENT_EXPIRATION_MINUTES;
  }
  ...
  static getMinWithdrawalAmount(): number {
    return Number(process.env.MIN_WITHDRAWAL_AMOUNT) || BUSINESS_DEFAULTS.MIN_WITHDRAWAL_AMOUNT;
  }
  ...
  static getWithdrawalFeeRate(): number {
    return Number(process.env.WITHDRAWAL_FEE_RATE) || BUSINESS_DEFAULTS.WITHDRAWAL_FEE_RATE;
  }
  ...
  static getMaxRefundDays(): number {
    return Number(process.env.MAX_REFUND_DAYS) || BUSINESS_DEFAULTS.MAX_REFUND_DAYS;
  }
  ...
  static getPlatformFeeRate(): number {
    return Number(process.env.PLATFORM_FEE_RATE) || BUSINESS_DEFAULTS.PLATFORM_FEE_RATE;
  }
